        ...
        <div className="space-y-6 p-6">
            ...
            <PageSection title="Episodic memory">
                ...
                <div className="mt-4 flex gap-2">
                    ...
                    <Button variant="secondary" size="md" disabled={busy} onClick={consolidateMemory} title="Squash older episodes into compact summaries">
                        Consolidate
                    </Button>
                </div>
                {memHits.length > 0 && (
            ...
            <PageSection title="Reflections">
                ...
                <div className="mt-4 flex gap-2">
                    <input
                        ...
                        className="flex-1 rounded-md border border-surface-4 bg-surface-2 px-3 py-1.5 text-sm"
                    />
                    <Button variant="subtle" size="md" disabled={busy} onClick={reflectionLookupSubmit}>
                        Lookup
                    </Button>
                </div>
                {refResults.length > 0 && (
            ...
            <PageSection title="Heartbeat scheduler">
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <Button variant="subtle" size="md" disabled={busy} onClick={heartbeatToggle}>
                        {hbStatus?.running ? 'Stop' : 'Start'}
                    </Button>
                    <Button variant="secondary" size="md" disabled={busy} onClick={heartbeatTickNow}>
                        Tick now
                    </Button>
                </div>
                ...
                <div className="mt-4 grid gap-2 md:grid-cols-3">
                    ...
                    />
                    <Button variant="subtle" size="md" disabled={busy || !newJobName || !newJobObjective} onClick={heartbeatAdd} className="md:col-span-2">
                        Add job
                    </Button>
                </div>
