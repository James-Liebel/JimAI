...
**Public repository:** [github.com/James-Liebel/JimAI](https://github.com/James-Liebel/JimAI) — there is no separate wrapper or second repo; clone this URL only.
...
On Windows, from the repo root you can run **`jimai.cmd`** (or **`jimai force`** if port 8000 is stuck) after Python venv and npm deps are installed.
